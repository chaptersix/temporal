module go.temporal.io/server/devtools

// This module exists solely to version heavy development tools without
// polluting the main go.mod dependency tree. Tools are installed into
// ../.bin/ by the mage targets or the Makefile.
//
// To update a tool:
//   cd devtools && go get <pkg>@<version> && go mod tidy

go 1.26.0

require (
	fillmore-labs.com/errortype v0.0.7
