...
CHASM_SCHEDULER_PROPERTY_SHARDS     ?= auto
...
chasm-scheduler-property-test:
	...
	@CGO_ENABLED=$(CGO_ENABLED) \
		CHASM_SCHEDULER_PROPERTY_TAGS=$(ALL_TEST_TAGS) \
		CHASM_SCHEDULER_PROPERTY_CHECKS=$(CHASM_SCHEDULER_PROPERTY_CHECKS) \
		CHASM_SCHEDULER_PROPERTY_STEPS=$(CHASM_SCHEDULER_PROPERTY_STEPS) \
		CHASM_SCHEDULER_PROPERTY_SHRINKTIME=$(CHASM_SCHEDULER_PROPERTY_SHRINKTIME) \
		CHASM_SCHEDULER_PROPERTY_TIMEOUT=$(CHASM_SCHEDULER_PROPERTY_TIMEOUT) \
		CHASM_SCHEDULER_PROPERTY_SHARDS=$(CHASM_SCHEDULER_PROPERTY_SHARDS) \
		bash ./chasm/lib/scheduler/testdata/run_property_campaign.sh \
		$(CHASM_SCHEDULER_RAPID_ARGS)
