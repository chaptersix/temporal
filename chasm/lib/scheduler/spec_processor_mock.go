...
// Source: chasm/lib/scheduler/spec_processor.go
//
// Generated by this command:
//
//	mockgen -package scheduler -source chasm/lib/scheduler/spec_processor.go -destination chasm/lib/scheduler/spec_processor_mock.go
//
...
func (m *MockSpecProcessor) ProcessTimeRange(arg0 *Scheduler, start, end time.Time, overlapPolicy enums.ScheduleOverlapPolicy, targetIDBase, backfillID string, manual bool, limit *int) (*ProcessedTimeRange, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessTimeRange", arg0, start, end, overlapPolicy, targetIDBase, backfillID, manual, limit)
...
func (mr *MockSpecProcessorMockRecorder) ProcessTimeRange(arg0, start, end, overlapPolicy, targetIDBase, backfillID, manual, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessTimeRange", reflect.TypeOf((*MockSpecProcessor)(nil).ProcessTimeRange), arg0, start, end, overlapPolicy, targetIDBase, backfillID, manual, limit)
}
