...
func (x *ImportScheduleRequest) Reset() {
	*x = ImportScheduleRequest{}
	mi := &file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ImportScheduleRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportScheduleRequest) ProtoMessage() {}

func (x *ImportScheduleRequest) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportScheduleRequest.ProtoReflect.Descriptor instead.
func (*ImportScheduleRequest) Descriptor() ([]byte, []int) {
	return file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_rawDescGZIP(), []int{12}
}

func (x *ImportScheduleRequest) GetNamespaceId() string {
	if x != nil {
		return x.NamespaceId
	}
	return ""
...
func (x *ImportScheduleRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ImportScheduleRequest) GetScheduleId() string {
	if x != nil {
		return x.ScheduleId
	}
	return ""
...
func (x *ImportScheduleRequest) GetSchedulerState() *SchedulerState {
	if x != nil {
...
func (x *ImportScheduleRequest) GetGeneratorState() *GeneratorState {
	if x != nil {
...
func (x *ImportScheduleRequest) GetInvokerState() *InvokerState {
	if x != nil {
...
func (x *ImportScheduleRequest) GetBackfillers() map[string]*BackfillerState {
	if x != nil {
...
func (x *ImportScheduleRequest) GetLastCompletionResult() *LastCompletionResult {
	if x != nil {
...
func (x *ImportScheduleRequest) GetSearchAttributes() map[string]*v11.Payload {
	if x != nil {
...
func (x *ImportScheduleRequest) GetMemo() map[string]*v11.Payload {
	if x != nil {
		return x.Memo
	}
	return nil
...
func (x *ImportScheduleResponse) Reset() {
	*x = ImportScheduleResponse{}
	mi := &file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ImportScheduleResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportScheduleResponse) ProtoMessage() {}

func (x *ImportScheduleResponse) ProtoReflect() protoreflect.Message {
	mi := &file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ImportScheduleResponse.ProtoReflect.Descriptor instead.
func (*ImportScheduleResponse) Descriptor() ([]byte, []int) {
...
const file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_rawDesc = "" +
	...
	"\x11frontend_response\x18\x01 \x01(\v2B.temporal.api.workflowservice.v1.ListScheduleMatchingTimesResponseR\x10frontendResponse\"\xc5\t\n" +
	"\x15ImportScheduleRequest\x12!\n" +
	...
	"\rinvoker_state\x18\x06 \x01(\v2:.temporal.server.chasm.lib.scheduler.proto.v1.InvokerStateR\finvokerState\x12v\n" +
	"\vbackfillers\x18\a \x03(\v2T.temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.BackfillersEntryR\vbackfillers\x12x\n" +
	"\x16last_completion_result\x18\b \x01(\v2B.temporal.server.chasm.lib.scheduler.proto.v1.LastCompletionResultR\x14lastCompletionResult\x12\x86\x01\n" +
	"\x11search_attributes\x18\t \x03(\v2Y.temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.SearchAttributesEntryR\x10searchAttributes\x12a\n" +
	"\x04memo\x18\n" +
	" \x03(\v2M.temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.MemoEntryR\x04memo\x1a}\n" +
	...
	"\tMemoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x125\n" +
	"\x05value\x18\x02 \x01(\v2\x1f.temporal.api.common.v1.PayloadR\x05value:\x028\x01\"\x18\n" +
	"\x16ImportScheduleResponseBGZEgo.temporal.io/server/chasm/lib/scheduler/gen/schedulerpb;schedulerpbb\x06proto3"
...
var file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_goTypes = []any{
	...
	(*ImportScheduleRequest)(nil),                // 12: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest
	(*ImportScheduleResponse)(nil),               // 13: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleResponse
	nil,                                          // 14: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.BackfillersEntry
	nil,                                          // 15: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.SearchAttributesEntry
	nil,                                          // 16: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.MemoEntry
...
var file_temporal_server_chasm_lib_scheduler_proto_v1_request_response_proto_depIdxs = []int32{
	...
	29, // 12: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.scheduler_state:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.SchedulerState
	30, // 13: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.generator_state:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.GeneratorState
	31, // 14: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.invoker_state:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.InvokerState
	14, // 15: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.backfillers:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.BackfillersEntry
	32, // 16: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.last_completion_result:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.LastCompletionResult
	15, // 17: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.search_attributes:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.SearchAttributesEntry
	16, // 18: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.memo:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.MemoEntry
	33, // 19: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.BackfillersEntry.value:type_name -> temporal.server.chasm.lib.scheduler.proto.v1.BackfillerState
	34, // 20: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.SearchAttributesEntry.value:type_name -> temporal.api.common.v1.Payload
	34, // 21: temporal.server.chasm.lib.scheduler.proto.v1.ImportScheduleRequest.MemoEntry.value:type_name -> temporal.api.common.v1.Payload
