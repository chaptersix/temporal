...
// Marshal an object of type CompletedResult to the protobuf v3 wire format
func (val *CompletedResult) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type CompletedResult from the protobuf v3 wire format
func (val *CompletedResult) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *CompletedResult) Size() int {
	return proto.Size(val)
}

// Equal returns whether two CompletedResult values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *CompletedResult) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *CompletedResult
	switch t := that.(type) {
